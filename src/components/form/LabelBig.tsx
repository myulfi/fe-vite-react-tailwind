        ...
        >
            ...
            <div
                className="
                    ...
                    overflow-auto
                    max-h-32 max-w-full
                    p-1 rounded bg-light-layout-secondary/50 dark:bg-dark-layout-secondary
...

            {
                password && (
                    <button
                        ...
                        className="absolute right-3 top-7 text-light-base-primary dark:text-dark-base-primary hover:text-light-base-secondary hover:dark:text-dark-base-secondary focus:outline-none cursor-pointer"
