        ...
        if (loginValidate(loginForm)) {
            ...
            try {
                ...
                if (HTTP_CODE.OK === response.status) {
                    ...
                    localStorage.setItem(LOCAL_STORAGE.NAME, response.data.user.nickName)
                    localStorage.setItem(LOCAL_STORAGE.ROLE, response.data.user.roleList)
        ...
        <div className="h-screen flex justify-between">
            <div
                ...
                style={{
                    inset: 0,
                    // top: 62,
                    backgroundImage: "url('https://images.unsplash.com/photo-1643080580358-9c24b10f6820?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
